        ...
        <div className=" h-[80vh] ">
          <div className=" h-full ">
            ...
            <button
              ...
              className="absolute bottom-[20%] left-[30vw] flex h-auto -translate-y-[20%]  cursor-pointer items-center justify-center bg-transparent p-2 hover:bg-[#4e4e4e56] md:bottom-[50%] md:left-[1vw] md:-translate-y-[50%]"
            >
              <img
                src={leftChevron}
            ...
            <button
              onClick={() => toggleImage(+1)}
              className="absolute bottom-[20%] right-[30vw] flex h-auto -translate-y-[20%] cursor-pointer items-center  justify-center bg-transparent p-2 hover:bg-[#4e4e4e56] md:bottom-[50%] md:right-[1vw] md:-translate-y-[50%] "
            >
              <img
                src={rightChevron}
                className="w-8 md:w-14 "
          ...
          <div className="ss:w-4/6 absolute bottom-[30vh] left-[5vw] w-5/6  min-w-[250px] space-y-2  sm:w-[50%] md:left-[10%]">
            ...
            <p className=" text-gray-400 opacity-95">{release_date}</p>
          </div>
        </div>
      )}
    </>
